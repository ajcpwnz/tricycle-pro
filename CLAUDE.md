...
- Bash 3.2+ (macOS default), 4.0+ (Linux) + Standard Unix utilities (`sed`, `awk`, `grep`, `printf`) (004-branch-naming-styles)
- File-based (YAML config, markdown output) (004-branch-naming-styles)
